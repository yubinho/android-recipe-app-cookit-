...
public class MenuBreakfastAdapter extends FirebaseRecyclerAdapter<Menu, MenuBreakfastAdapter.myviewholder> {
    String userId = FirebaseAuth.getInstance().getCurrentUser().getUid();
    private Activity activity;
    public MenuBreakfastAdapter(@NonNull FirebaseRecyclerOptions<Menu> options,Activity activity){
        super(options);
        this.activity = activity;
    }
    @Override
    protected void onBindViewHolder(@NonNull MenuBreakfastAdapter.myviewholder holder, int position, @NonNull Menu model) {
            ...
            public void onClick(View v) {
                ...
                alertDialog.setPositiveButton("確定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        try{
                            FirebaseDatabase.getInstance().getReference("customMenu").child(userId).child("早餐")
    ...
    @NonNull
    @Override
    public MenuBreakfastAdapter.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.menu_singlerow,parent,false);
        return new MenuBreakfastAdapter.myviewholder(view);
    }
