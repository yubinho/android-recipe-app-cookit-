...
public class Menu {
    public String name,category,recipeName,recipeInfo,recipeIngredient,step1,step2,step3,step4,step5,step6,step7,step8,step9,step10,purl,uid,imageStep1,imageStep2,imageStep3,imageStep4,imageStep5,imageStep6,imageStep7,imageStep8,imageStep9,imageStep10,checked,date,time;
    public double calorie;
    private int clickCount;
    public Menu() {}
    public Menu(String name,String category,String recipeName,String recipeInfo,
                  ...
                  String purl,String uid,String imageStep1,String imageStep2,String imageStep3,String imageStep4,String imageStep5,String imageStep6,String imageStep7,String imageStep8,String imageStep9,String imageStep10,
                String checked,double calorie,String date,String time,int clickCount){
        this.name = name;
