...
public class IndexNewsAdapter extends FirebaseRecyclerAdapter<Recipe, IndexNewsAdapter.myviewholder> {
    int clickCount,order;
    String recipeKey;
    int orderMax = 999999999;
    FirebaseUser user = FirebaseAuth.getInstance().getCurrentUser();
    String userID;
    public IndexNewsAdapter(@NonNull FirebaseRecyclerOptions<Recipe> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull Recipe model) {
        ...
        recipeKey = getRef(position).getKey();
