...
public class RecipeHistoryAdapter extends FirebaseRecyclerAdapter<Recipe, RecipeHistoryAdapter.myviewholder> {
    String userId = FirebaseAuth.getInstance().getCurrentUser().getUid();
    public RecipeHistoryAdapter(@NonNull FirebaseRecyclerOptions<Recipe> options) {
        super(options);
    }
    ...
    @NonNull
    @Override
    public RecipeHistoryAdapter.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recipe_favorite_singlerow, parent, false);
        return new RecipeHistoryAdapter.myviewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull Recipe model) {
        ...
        holder.recipeDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alertDialog.setMessage("確定要刪除紀錄嗎?");
